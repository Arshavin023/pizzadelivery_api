...
#     class Config:
#         from_attributes=True # Enable ORM mode for automatic mapping from SQLAlchemy models
...
# Ensure you have installed fastapi-jwt-auth2 via pip
from fastapi_jwt_auth2 import AuthJWT

db_param = read_db_config()

# --- Common Config ---
# 'from_attributes=True' replaces the old 'orm_mode=True'
v2_config = ConfigDict(from_attributes=True)
